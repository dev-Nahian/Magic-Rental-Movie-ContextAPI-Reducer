              ...
              cartData.map((item)=>(
                <div key={item.id} className="grid grid-cols-[1fr_auto] gap-4">
                  ...
                  <div className="flex justify-between gap-4 items-center">
                    <button onClick={()=>handleDeleteCart(event, item.id)} className="bg-[#D42967] rounded-md p-2 md:px-4 inline-flex items-center space-x-2 text-white">
                      
                      <img className="w-5 h-5" src={DeleteIcon} alt="not found" />
